 ...
 */
public class GetEmailHarness extends IMAPEmailHarness implements RunHarness
{
    private static final Logger log = Logger.getLogger(GetEmailHarness.class.getName());
