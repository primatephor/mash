...
public class ParameterBuilder
{
    ...
    public List<Parameter> applyParameters(List<RunHarness> previousRun,
                                           ...
                                           ScriptDefinition scriptDefinition) throws Exception
    {
        HarnessDefinition definition = currentHarness.getDefinition();
        return applyParameters(previousRun, scriptDefinition, definition);
    }
